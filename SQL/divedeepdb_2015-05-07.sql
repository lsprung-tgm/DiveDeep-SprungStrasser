...
# Database: divedeepdb
# Generation Time: 2015-05-07 09:18:56 +0000
# ************************************************************
...
# Dump of table yfedk_assets
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_assets`;

CREATE TABLE `yfedk_assets` (
...
LOCK TABLES `yfedk_assets` WRITE;
/*!40000 ALTER TABLE `yfedk_assets` DISABLE KEYS */;

INSERT INTO `yfedk_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`)
VALUES
...
/*!40000 ALTER TABLE `yfedk_assets` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_associations
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_associations`;

CREATE TABLE `yfedk_associations` (
...
# Dump of table yfedk_banner_clients
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_banner_clients`;

CREATE TABLE `yfedk_banner_clients` (
...
# Dump of table yfedk_banner_tracks
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_banner_tracks`;

CREATE TABLE `yfedk_banner_tracks` (
...
# Dump of table yfedk_banners
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_banners`;

CREATE TABLE `yfedk_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Dump of table yfedk_categories
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_categories`;

CREATE TABLE `yfedk_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `yfedk_categories` WRITE;
/*!40000 ALTER TABLE `yfedk_categories` DISABLE KEYS */;

INSERT INTO `yfedk_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`)
VALUES
...
/*!40000 ALTER TABLE `yfedk_categories` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_contact_details
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_contact_details`;

CREATE TABLE `yfedk_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
# Dump of table yfedk_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_content`;

CREATE TABLE `yfedk_content` (
...
# Dump of table yfedk_content_frontpage
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_content_frontpage`;

CREATE TABLE `yfedk_content_frontpage` (
...
# Dump of table yfedk_content_rating
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_content_rating`;

CREATE TABLE `yfedk_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
# Dump of table yfedk_content_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_content_types`;

CREATE TABLE `yfedk_content_types` (
...
LOCK TABLES `yfedk_content_types` WRITE;
/*!40000 ALTER TABLE `yfedk_content_types` DISABLE KEYS */;

INSERT INTO `yfedk_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`)
VALUES
...
/*!40000 ALTER TABLE `yfedk_content_types` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_contentitem_tag_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_contentitem_tag_map`;

CREATE TABLE `yfedk_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
# Dump of table yfedk_core_log_searches
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_core_log_searches`;

CREATE TABLE `yfedk_core_log_searches` (
...
# Dump of table yfedk_extensions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_extensions`;

CREATE TABLE `yfedk_extensions` (
...
LOCK TABLES `yfedk_extensions` WRITE;
/*!40000 ALTER TABLE `yfedk_extensions` DISABLE KEYS */;

INSERT INTO `yfedk_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`)
VALUES
	...
	(103,'Joomla! Platform','library','joomla','',0,1,1,1,'{\"name\":\"Joomla! Platform\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"http:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}','{\"mediaversion\":\"3b52d9efd17fdef7a17a9c63fc514348\"}','','',0,'0000-00-00 00:00:00',0,0),
	...
	(10000,'blog-sunny-blue','template','blog-sunny-blue','',0,1,1,0,'{\"name\":\"blog-sunny-blue\",\"type\":\"template\",\"creationDate\":\"02 February 2015\",\"author\":\"SiteGround\",\"copyright\":\"Copyright (C) 2005 - 2014 Open Source Matters, Inc. All rights reserved.\",\"authorEmail\":\"hristo.p@siteground.com\",\"authorUrl\":\"\",\"version\":\"1.0\",\"description\":\"TPL_BLOG-SUNNY-BLUE_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"templateDetails\"}','{\"logoFile\":\"\",\"sitetitle\":\"\",\"sitedescription\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\"}','','',0,'0000-00-00 00:00:00',0,0);

/*!40000 ALTER TABLE `yfedk_extensions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_finder_filters
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_filters`;

CREATE TABLE `yfedk_finder_filters` (
...
# Dump of table yfedk_finder_links
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links`;

CREATE TABLE `yfedk_finder_links` (
...
# Dump of table yfedk_finder_links_terms0
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms0`;

CREATE TABLE `yfedk_finder_links_terms0` (
...
# Dump of table yfedk_finder_links_terms1
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms1`;

CREATE TABLE `yfedk_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms2
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms2`;

CREATE TABLE `yfedk_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms3
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms3`;

CREATE TABLE `yfedk_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms4
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms4`;

CREATE TABLE `yfedk_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms5
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms5`;

CREATE TABLE `yfedk_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms6
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms6`;

CREATE TABLE `yfedk_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms7
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms7`;

CREATE TABLE `yfedk_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms8
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms8`;

CREATE TABLE `yfedk_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_terms9
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_terms9`;

CREATE TABLE `yfedk_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termsa
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termsa`;

CREATE TABLE `yfedk_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termsb
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termsb`;

CREATE TABLE `yfedk_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termsc
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termsc`;

CREATE TABLE `yfedk_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termsd
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termsd`;

CREATE TABLE `yfedk_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termse
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termse`;

CREATE TABLE `yfedk_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_links_termsf
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_links_termsf`;

CREATE TABLE `yfedk_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Dump of table yfedk_finder_taxonomy
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_taxonomy`;

CREATE TABLE `yfedk_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
LOCK TABLES `yfedk_finder_taxonomy` WRITE;
/*!40000 ALTER TABLE `yfedk_finder_taxonomy` DISABLE KEYS */;

INSERT INTO `yfedk_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`)
VALUES
	(1,0,'ROOT',0,0,0);

/*!40000 ALTER TABLE `yfedk_finder_taxonomy` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_finder_taxonomy_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_taxonomy_map`;

CREATE TABLE `yfedk_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
# Dump of table yfedk_finder_terms
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_terms`;

CREATE TABLE `yfedk_finder_terms` (
...
# Dump of table yfedk_finder_terms_common
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_terms_common`;

CREATE TABLE `yfedk_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
LOCK TABLES `yfedk_finder_terms_common` WRITE;
/*!40000 ALTER TABLE `yfedk_finder_terms_common` DISABLE KEYS */;

INSERT INTO `yfedk_finder_terms_common` (`term`, `language`)
VALUES
	('a','en'),
	('about','en'),
	('after','en'),
...
/*!40000 ALTER TABLE `yfedk_finder_terms_common` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_finder_tokens
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_tokens`;

CREATE TABLE `yfedk_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
# Dump of table yfedk_finder_tokens_aggregate
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_tokens_aggregate`;

CREATE TABLE `yfedk_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
# Dump of table yfedk_finder_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_finder_types`;

CREATE TABLE `yfedk_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table yfedk_languages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_languages`;

CREATE TABLE `yfedk_languages` (
...
LOCK TABLES `yfedk_languages` WRITE;
/*!40000 ALTER TABLE `yfedk_languages` DISABLE KEYS */;

INSERT INTO `yfedk_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`)
VALUES
	(1,'en-GB','English (UK)','English (UK)','en','en','','','','',1,1,1);

/*!40000 ALTER TABLE `yfedk_languages` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_menu`;

CREATE TABLE `yfedk_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `yfedk_menu` WRITE;
/*!40000 ALTER TABLE `yfedk_menu` DISABLE KEYS */;

INSERT INTO `yfedk_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`)
VALUES
	...
	(7,'menu','com_contact',X'436F6E7461637473','','Contacts','index.php?option=com_contact','component',0,1,1,8,0,'0000-00-00 00:00:00',0,0,'class:contact',0,'',11,16,0,'*',1),
	(8,'menu','com_contact',X'436F6E7461637473','','Contacts/Contacts','index.php?option=com_contact','component',0,7,2,8,0,'0000-00-00 00:00:00',0,0,'class:contact',0,'',12,13,0,'*',1),
	(9,'menu','com_contact_categories',X'43617465676F72696573','','Contacts/Categories','index.php?option=com_categories&extension=com_contact','component',0,7,2,6,0,'0000-00-00 00:00:00',0,0,'class:contact-cat',0,'',14,15,0,'*',1),
	(10,'menu','com_messages',X'4D6573736167696E67','','Messaging','index.php?option=com_messages','component',0,1,1,15,0,'0000-00-00 00:00:00',0,0,'class:messages',0,'',17,22,0,'*',1),
	(11,'menu','com_messages_add',X'4E65772050726976617465204D657373616765','','Messaging/New Private Message','index.php?option=com_messages&task=message.add','component',0,10,2,15,0,'0000-00-00 00:00:00',0,0,'class:messages-add',0,'',18,19,0,'*',1),
	(12,'menu','com_messages_read',X'526561642050726976617465204D657373616765','','Messaging/Read Private Message','index.php?option=com_messages','component',0,10,2,15,0,'0000-00-00 00:00:00',0,0,'class:messages-read',0,'',20,21,0,'*',1),
	(13,'menu','com_newsfeeds',X'4E657773204665656473','','News Feeds','index.php?option=com_newsfeeds','component',0,1,1,17,0,'0000-00-00 00:00:00',0,0,'class:newsfeeds',0,'',23,28,0,'*',1),
	(14,'menu','com_newsfeeds_feeds',X'4665656473','','News Feeds/Feeds','index.php?option=com_newsfeeds','component',0,13,2,17,0,'0000-00-00 00:00:00',0,0,'class:newsfeeds',0,'',24,25,0,'*',1),
	(15,'menu','com_newsfeeds_categories',X'43617465676F72696573','','News Feeds/Categories','index.php?option=com_categories&extension=com_newsfeeds','component',0,13,2,6,0,'0000-00-00 00:00:00',0,0,'class:newsfeeds-cat',0,'',26,27,0,'*',1),
	(16,'menu','com_redirect',X'5265646972656374','','Redirect','index.php?option=com_redirect','component',0,1,1,24,0,'0000-00-00 00:00:00',0,0,'class:redirect',0,'',29,30,0,'*',1),
	(17,'menu','com_search',X'426173696320536561726368','','Basic Search','index.php?option=com_search','component',0,1,1,19,0,'0000-00-00 00:00:00',0,0,'class:search',0,'',31,32,0,'*',1),
	(18,'menu','com_finder',X'536D61727420536561726368','','Smart Search','index.php?option=com_finder','component',0,1,1,27,0,'0000-00-00 00:00:00',0,0,'class:finder',0,'',33,34,0,'*',1),
	(19,'menu','com_joomlaupdate',X'4A6F6F6D6C612120557064617465','','Joomla! Update','index.php?option=com_joomlaupdate','component',1,1,1,28,0,'0000-00-00 00:00:00',0,0,'class:joomlaupdate',0,'',35,36,0,'*',1),
	(20,'main','com_tags',X'54616773','','Tags','index.php?option=com_tags','component',0,1,1,29,0,'0000-00-00 00:00:00',0,1,'class:tags',0,'',37,38,0,'',1),
	(21,'main','com_postinstall',X'506F73742D696E7374616C6C6174696F6E206D65737361676573','','Post-installation messages','index.php?option=com_postinstall','component',0,1,1,32,0,'0000-00-00 00:00:00',0,1,'class:postinstall',0,'',39,40,0,'*',1),
	(101,'mainmenu','Willkommen auf DiveDeep',X'686F6D65','','home','index.php?option=com_content&view=featured','component',1,1,1,22,410,'2015-05-07 09:14:43',0,1,'',0,'{\"featured_categories\":[\"\"],\"layout_type\":\"blog\",\"num_leading_articles\":\"1\",\"num_intro_articles\":\"3\",\"num_columns\":\"3\",\"num_links\":\"0\",\"multi_column_order\":\"1\",\"orderby_pri\":\"\",\"orderby_sec\":\"front\",\"order_date\":\"\",\"show_pagination\":\"2\",\"show_pagination_results\":\"1\",\"show_title\":\"\",\"link_titles\":\"\",\"show_intro\":\"\",\"info_block_position\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_vote\":\"\",\"show_readmore\":\"\",\"show_readmore_title\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_hits\":\"\",\"show_tags\":\"\",\"show_noauth\":\"\",\"show_feed_link\":\"1\",\"feed_summary\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"\",\"show_page_heading\":\"1\",\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',41,42,1,'*',0);

/*!40000 ALTER TABLE `yfedk_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_menu_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_menu_types`;

CREATE TABLE `yfedk_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `yfedk_menu_types` WRITE;
/*!40000 ALTER TABLE `yfedk_menu_types` DISABLE KEYS */;

INSERT INTO `yfedk_menu_types` (`id`, `menutype`, `title`, `description`)
VALUES
	(1,'mainmenu','Main Menu','The main menu for the site');

/*!40000 ALTER TABLE `yfedk_menu_types` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_messages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_messages`;

CREATE TABLE `yfedk_messages` (
...
# Dump of table yfedk_messages_cfg
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_messages_cfg`;

CREATE TABLE `yfedk_messages_cfg` (
...
# Dump of table yfedk_modules
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_modules`;

CREATE TABLE `yfedk_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
LOCK TABLES `yfedk_modules` WRITE;
/*!40000 ALTER TABLE `yfedk_modules` DISABLE KEYS */;

INSERT INTO `yfedk_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`)
VALUES
...
/*!40000 ALTER TABLE `yfedk_modules` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_modules_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_modules_menu`;

CREATE TABLE `yfedk_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `yfedk_modules_menu` WRITE;
/*!40000 ALTER TABLE `yfedk_modules_menu` DISABLE KEYS */;

INSERT INTO `yfedk_modules_menu` (`moduleid`, `menuid`)
VALUES
	(1,0),
	(2,0),
	(3,0),
...
/*!40000 ALTER TABLE `yfedk_modules_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_newsfeeds
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_newsfeeds`;

CREATE TABLE `yfedk_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table yfedk_overrider
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_overrider`;

CREATE TABLE `yfedk_overrider` (
...
# Dump of table yfedk_postinstall_messages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_postinstall_messages`;

CREATE TABLE `yfedk_postinstall_messages` (
...
LOCK TABLES `yfedk_postinstall_messages` WRITE;
/*!40000 ALTER TABLE `yfedk_postinstall_messages` DISABLE KEYS */;

INSERT INTO `yfedk_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`)
VALUES
	(1,700,'PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_TITLE','PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_BODY','PLG_TWOFACTORAUTH_TOTP_POSTINSTALL_ACTION','plg_twofactorauth_totp',1,'action','site://plugins/twofactorauth/totp/postinstall/actions.php','twofactorauth_postinstall_action','site://plugins/twofactorauth/totp/postinstall/actions.php','twofactorauth_postinstall_condition','3.2.0',1),
	(2,700,'COM_CPANEL_WELCOME_BEGINNERS_TITLE','COM_CPANEL_WELCOME_BEGINNERS_MESSAGE','','com_cpanel',1,'message','','','','','3.2.0',1);

/*!40000 ALTER TABLE `yfedk_postinstall_messages` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_redirect_links
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_redirect_links`;

CREATE TABLE `yfedk_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table yfedk_schemas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_schemas`;

CREATE TABLE `yfedk_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `yfedk_schemas` WRITE;
/*!40000 ALTER TABLE `yfedk_schemas` DISABLE KEYS */;

INSERT INTO `yfedk_schemas` (`extension_id`, `version_id`)
VALUES
	(700,'3.4.0-2015-02-26');

/*!40000 ALTER TABLE `yfedk_schemas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_session
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_session`;

CREATE TABLE `yfedk_session` (
...
LOCK TABLES `yfedk_session` WRITE;
/*!40000 ALTER TABLE `yfedk_session` DISABLE KEYS */;

INSERT INTO `yfedk_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`)
VALUES
	('69b6cbb483ee0bb5349d67d318753285',0,0,'1430990161','__default|a:8:{s:15:\"session.counter\";i:11;s:19:\"session.timer.start\";i:1430989610;s:18:\"session.timer.last\";i:1430990032;s:17:\"session.timer.now\";i:1430990161;s:22:\"session.client.browser\";s:118:\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/600.4.10 (KHTML, like Gecko) Version/8.0.4 Safari/600.4.10\";s:8:\"registry\";O:24:\"Joomla\\Registry\\Registry\":2:{s:7:\"\\0\\0\\0data\";O:8:\"stdClass\":3:{s:5:\"users\";O:8:\"stdClass\":1:{s:5:\"login\";O:8:\"stdClass\":1:{s:4:\"form\";O:8:\"stdClass\":2:{s:4:\"data\";a:0:{}s:6:\"return\";s:62:\"http://localhost:8888/DiveDeep-SprungStrasser/Joomla-DiveDeep/\";}}}s:11:\"com_modules\";O:8:\"stdClass\":2:{s:4:\"edit\";O:8:\"stdClass\":1:{s:6:\"module\";O:8:\"stdClass\":1:{s:4:\"data\";N;}}s:3:\"add\";O:8:\"stdClass\":1:{s:6:\"module\";O:8:\"stdClass\":2:{s:12:\"extension_id\";N;s:6:\"params\";N;}}}s:10:\"com_config\";O:8:\"stdClass\":1:{s:6:\"config\";O:8:\"stdClass\":1:{s:6:\"global\";O:8:\"stdClass\":1:{s:4:\"data\";N;}}}}s:9:\"separator\";s:1:\".\";}s:4:\"user\";O:5:\"JUser\":28:{s:9:\"\\0\\0\\0isRoot\";b:1;s:2:\"id\";s:3:\"410\";s:4:\"name\";s:10:\"Super User\";s:8:\"username\";s:14:\"SprungStrasser\";s:5:\"email\";s:16:\"dominik96@me.com\";s:8:\"password\";s:60:\"$2y$10$CaJqZIpPGvZcj7bOtnGe3.6YODAvFQzZKLzwEpt2w48Pefsx3s.72\";s:14:\"password_clear\";s:0:\"\";s:5:\"block\";s:1:\"0\";s:9:\"sendEmail\";s:1:\"1\";s:12:\"registerDate\";s:19:\"2015-05-07 08:54:39\";s:13:\"lastvisitDate\";s:19:\"2015-05-07 09:06:49\";s:10:\"activation\";s:1:\"0\";s:6:\"params\";s:0:\"\";s:6:\"groups\";a:1:{i:8;s:1:\"8\";}s:5:\"guest\";i:0;s:13:\"lastResetTime\";s:19:\"0000-00-00 00:00:00\";s:10:\"resetCount\";s:1:\"0\";s:12:\"requireReset\";s:1:\"0\";s:10:\"\\0\\0\\0_params\";O:24:\"Joomla\\Registry\\Registry\":2:{s:7:\"\\0\\0\\0data\";O:8:\"stdClass\":0:{}s:9:\"separator\";s:1:\".\";}s:14:\"\\0\\0\\0_authGroups\";a:2:{i:0;i:1;i:1;i:8;}s:14:\"\\0\\0\\0_authLevels\";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:\"\\0\\0\\0_authActions\";N;s:12:\"\\0\\0\\0_errorMsg\";N;s:13:\"\\0\\0\\0userHelper\";O:18:\"JUserWrapperHelper\":0:{}s:10:\"\\0\\0\\0_errors\";a:0:{}s:3:\"aid\";i:0;s:6:\"otpKey\";s:0:\"\";s:4:\"otep\";s:0:\"\";}s:13:\"session.token\";s:32:\"52e5af97fa7e58c80a59cdf44931e97b\";}',410,'SprungStrasser'),
	('cfaad37d229d5a014fec56d14557b4d8',1,0,'1430990084','__default|a:9:{s:15:\"session.counter\";i:49;s:19:\"session.timer.start\";i:1430988893;s:18:\"session.timer.last\";i:1430990083;s:17:\"session.timer.now\";i:1430990083;s:22:\"session.client.browser\";s:118:\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/600.4.10 (KHTML, like Gecko) Version/8.0.4 Safari/600.4.10\";s:8:\"registry\";O:24:\"Joomla\\Registry\\Registry\":2:{s:7:\"\\0\\0\\0data\";O:8:\"stdClass\":6:{s:11:\"application\";O:8:\"stdClass\":1:{s:4:\"lang\";s:5:\"en-GB\";}s:13:\"com_installer\";O:8:\"stdClass\":3:{s:7:\"message\";s:0:\"\";s:17:\"extension_message\";s:0:\"\";s:12:\"redirect_url\";N;}s:13:\"com_templates\";O:8:\"stdClass\":2:{s:6:\"styles\";O:8:\"stdClass\":4:{s:6:\"filter\";O:8:\"stdClass\":3:{s:6:\"search\";s:0:\"\";s:8:\"template\";s:0:\"\";s:9:\"client_id\";s:0:\"\";}s:8:\"ordercol\";s:10:\"a.template\";s:9:\"orderdirn\";s:3:\"asc\";s:10:\"limitstart\";i:0;}s:4:\"edit\";O:8:\"stdClass\":1:{s:5:\"style\";O:8:\"stdClass\":2:{s:2:\"id\";a:0:{}s:4:\"data\";N;}}}s:6:\"global\";O:8:\"stdClass\":1:{s:4:\"list\";O:8:\"stdClass\":1:{s:5:\"limit\";i:20;}}s:10:\"com_config\";O:8:\"stdClass\":1:{s:6:\"config\";O:8:\"stdClass\":1:{s:6:\"global\";O:8:\"stdClass\":1:{s:4:\"data\";N;}}}s:9:\"com_menus\";O:8:\"stdClass\":2:{s:5:\"items\";O:8:\"stdClass\":3:{s:8:\"menutype\";s:8:\"mainmenu\";s:10:\"limitstart\";i:0;s:4:\"list\";a:4:{s:9:\"direction\";s:3:\"asc\";s:5:\"limit\";i:20;s:8:\"ordering\";s:5:\"a.lft\";s:5:\"start\";d:0;}}s:4:\"edit\";O:8:\"stdClass\":1:{s:4:\"item\";O:8:\"stdClass\":4:{s:2:\"id\";a:1:{i:0;i:101;}s:4:\"data\";N;s:4:\"type\";N;s:4:\"link\";N;}}}}s:9:\"separator\";s:1:\".\";}s:4:\"user\";O:5:\"JUser\":28:{s:9:\"\\0\\0\\0isRoot\";b:1;s:2:\"id\";s:3:\"410\";s:4:\"name\";s:10:\"Super User\";s:8:\"username\";s:14:\"SprungStrasser\";s:5:\"email\";s:16:\"dominik96@me.com\";s:8:\"password\";s:60:\"$2y$10$CaJqZIpPGvZcj7bOtnGe3.6YODAvFQzZKLzwEpt2w48Pefsx3s.72\";s:14:\"password_clear\";s:0:\"\";s:5:\"block\";s:1:\"0\";s:9:\"sendEmail\";s:1:\"1\";s:12:\"registerDate\";s:19:\"2015-05-07 08:54:39\";s:13:\"lastvisitDate\";s:19:\"0000-00-00 00:00:00\";s:10:\"activation\";s:1:\"0\";s:6:\"params\";s:0:\"\";s:6:\"groups\";a:1:{i:8;s:1:\"8\";}s:5:\"guest\";i:0;s:13:\"lastResetTime\";s:19:\"0000-00-00 00:00:00\";s:10:\"resetCount\";s:1:\"0\";s:12:\"requireReset\";s:1:\"0\";s:10:\"\\0\\0\\0_params\";O:24:\"Joomla\\Registry\\Registry\":2:{s:7:\"\\0\\0\\0data\";O:8:\"stdClass\":0:{}s:9:\"separator\";s:1:\".\";}s:14:\"\\0\\0\\0_authGroups\";a:2:{i:0;i:1;i:1;i:8;}s:14:\"\\0\\0\\0_authLevels\";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:\"\\0\\0\\0_authActions\";N;s:12:\"\\0\\0\\0_errorMsg\";N;s:13:\"\\0\\0\\0userHelper\";O:18:\"JUserWrapperHelper\":0:{}s:10:\"\\0\\0\\0_errors\";a:0:{}s:3:\"aid\";i:0;s:6:\"otpKey\";s:0:\"\";s:4:\"otep\";s:0:\"\";}s:13:\"session.token\";s:32:\"afbebb236e0d9c8b9658eabb2807d997\";s:20:\"com_media.return_url\";s:26:\"index.php?option=com_media\";}',410,'SprungStrasser');

/*!40000 ALTER TABLE `yfedk_session` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_tags
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_tags`;

CREATE TABLE `yfedk_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
LOCK TABLES `yfedk_tags` WRITE;
/*!40000 ALTER TABLE `yfedk_tags` DISABLE KEYS */;

INSERT INTO `yfedk_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`)
VALUES
...
/*!40000 ALTER TABLE `yfedk_tags` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_template_styles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_template_styles`;

CREATE TABLE `yfedk_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `yfedk_template_styles` WRITE;
/*!40000 ALTER TABLE `yfedk_template_styles` DISABLE KEYS */;

INSERT INTO `yfedk_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`)
VALUES
	(4,'beez3',0,'0','Beez3 - Default','{\"wrapperSmall\":\"53\",\"wrapperLarge\":\"72\",\"logo\":\"images\\/joomla_black.gif\",\"sitetitle\":\"Joomla!\",\"sitedescription\":\"Open Source Content Management\",\"navposition\":\"left\",\"templatecolor\":\"personal\",\"html5\":\"0\"}'),
	(5,'hathor',1,'0','Hathor - Default','{\"showSiteName\":\"0\",\"colourChoice\":\"\",\"boldText\":\"0\"}'),
	(7,'protostar',0,'0','protostar - Default','{\"templateColor\":\"\",\"logoFile\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\",\"fluidContainer\":\"0\"}'),
	(8,'isis',1,'1','isis - Default','{\"templateColor\":\"\",\"logoFile\":\"\"}'),
	(9,'blog-sunny-blue',0,'1','Sunny Blue Template','{\"logoFile\":\"\",\"sitetitle\":\"\",\"sitedescription\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\"}');

/*!40000 ALTER TABLE `yfedk_template_styles` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_ucm_base
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_ucm_base`;

CREATE TABLE `yfedk_ucm_base` (
...
# Dump of table yfedk_ucm_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_ucm_content`;

CREATE TABLE `yfedk_ucm_content` (
...
# Dump of table yfedk_ucm_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_ucm_history`;

CREATE TABLE `yfedk_ucm_history` (
...
# Dump of table yfedk_update_sites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_update_sites`;

CREATE TABLE `yfedk_update_sites` (
...
LOCK TABLES `yfedk_update_sites` WRITE;
/*!40000 ALTER TABLE `yfedk_update_sites` DISABLE KEYS */;

INSERT INTO `yfedk_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`)
VALUES
	(1,'Joomla! Core','collection','http://update.joomla.org/core/list.xml',1,1430989652,''),
	(2,'Joomla! Extension Directory','collection','http://update.joomla.org/jed/list.xml',1,1430989652,''),
...
/*!40000 ALTER TABLE `yfedk_update_sites` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_update_sites_extensions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_update_sites_extensions`;

CREATE TABLE `yfedk_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

LOCK TABLES `yfedk_update_sites_extensions` WRITE;
/*!40000 ALTER TABLE `yfedk_update_sites_extensions` DISABLE KEYS */;

INSERT INTO `yfedk_update_sites_extensions` (`update_site_id`, `extension_id`)
VALUES
	(1,700),
	(2,700),
	(3,600),
...
/*!40000 ALTER TABLE `yfedk_update_sites_extensions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_updates
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_updates`;

CREATE TABLE `yfedk_updates` (
...
# Dump of table yfedk_user_keys
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_user_keys`;

CREATE TABLE `yfedk_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table yfedk_user_notes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_user_notes`;

CREATE TABLE `yfedk_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
# Dump of table yfedk_user_profiles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_user_profiles`;

CREATE TABLE `yfedk_user_profiles` (
...
# Dump of table yfedk_user_usergroup_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_user_usergroup_map`;

CREATE TABLE `yfedk_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `yfedk_user_usergroup_map` WRITE;
/*!40000 ALTER TABLE `yfedk_user_usergroup_map` DISABLE KEYS */;

INSERT INTO `yfedk_user_usergroup_map` (`user_id`, `group_id`)
VALUES
	(410,8);

/*!40000 ALTER TABLE `yfedk_user_usergroup_map` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_usergroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_usergroups`;

CREATE TABLE `yfedk_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
LOCK TABLES `yfedk_usergroups` WRITE;
/*!40000 ALTER TABLE `yfedk_usergroups` DISABLE KEYS */;

INSERT INTO `yfedk_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`)
VALUES
	(1,0,1,18,'Public'),
	(2,1,8,15,'Registered'),
	(3,2,9,14,'Author'),
...
/*!40000 ALTER TABLE `yfedk_usergroups` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_users
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_users`;

CREATE TABLE `yfedk_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
LOCK TABLES `yfedk_users` WRITE;
/*!40000 ALTER TABLE `yfedk_users` DISABLE KEYS */;

INSERT INTO `yfedk_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`)
VALUES
	(410,'Super User','SprungStrasser','dominik96@me.com','$2y$10$CaJqZIpPGvZcj7bOtnGe3.6YODAvFQzZKLzwEpt2w48Pefsx3s.72',0,1,'2015-05-07 08:54:39','2015-05-07 09:06:59','0','','0000-00-00 00:00:00',0,'','',0);

/*!40000 ALTER TABLE `yfedk_users` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yfedk_viewlevels
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yfedk_viewlevels`;

CREATE TABLE `yfedk_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
LOCK TABLES `yfedk_viewlevels` WRITE;
/*!40000 ALTER TABLE `yfedk_viewlevels` DISABLE KEYS */;

INSERT INTO `yfedk_viewlevels` (`id`, `title`, `ordering`, `rules`)
VALUES
	(1,'Public',0,'[1]'),
...
/*!40000 ALTER TABLE `yfedk_viewlevels` ENABLE KEYS */;
UNLOCK TABLES;
